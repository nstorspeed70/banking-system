...
/**
 * DTO para la creaciu00f3n de un nuevo miembro
 */
...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'El ID de la empresa es requerido' }),
    (0, class_validator_1.IsUUID)('4', { message: 'El ID de la empresa debe ser un UUID vu00e1lido' }),
    __metadata("design:type", String)
], CreatePartyDto.prototype, "enterpriseId", void 0);
